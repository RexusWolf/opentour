...
export class addUser1609184562041 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'CREATE TABLE `users` (`id` varchar(36) NOT NULL, `email` varchar(255) NOT NULL, `password` varchar(70) NOT NULL, `roles` text NOT NULL, UNIQUE INDEX `IDX_fe0bb3f6520ee0469504521e71` (`email`), PRIMARY KEY (`id`)) ENGINE=InnoDB'
    );
    await queryRunner.query(
