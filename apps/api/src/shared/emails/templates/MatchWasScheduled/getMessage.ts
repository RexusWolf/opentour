export default function getMessage(competitionUrl: string): string {
  return `
    <p>Hola!</p>
    <p>Uno de los partidos de una competición en la que te inscribiste acaba de ser fechado. Puedes entrar a la página de la competición para ver la fecha del partido pulsando el botón más abajo.</p>
