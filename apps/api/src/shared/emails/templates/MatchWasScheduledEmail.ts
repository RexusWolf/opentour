...
import getMessage from './MatchWasScheduled/getMessage';
import getSubject from './MatchWasScheduled/getSubject';
...
export class MatchWasScheduledEmail implements Email {
